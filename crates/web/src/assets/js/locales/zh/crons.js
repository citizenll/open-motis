...
export default {
	...
	heartbeat: {
		...
		deliveryTitle: "投递",
		deliveryDescription: "将心跳回复发送到频道/聊天目标。",
		deliverToChannel: "发送到频道",
		channelAccountLabel: "频道账号",
		channelAccountPlaceholder: "my-bot",
		chatIdLabel: "聊天 ID",
		chatIdPlaceholder: "123456789",
		deliveryRequirementsHint: "启用投递时为必填。账号是你配置的频道账号 ID，聊天 ID 是目标接收者/群组 ID。",
		enableSandbox: "启用沙盒",
		sandboxImageLabel: "沙盒镜像",
		sandboxImagePlaceholder: "默认镜像",
		sandboxSearchPlaceholder: "搜索镜像\u2026",
		sandboxDefault: "沙盒（默认）",
		searchChannelsPlaceholder: "搜索频道\u2026",
		selectChannelAccount: "选择频道账号",
